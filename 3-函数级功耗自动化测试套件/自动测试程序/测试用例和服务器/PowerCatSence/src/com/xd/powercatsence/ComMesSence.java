...
public class ComMesSence extends SenceThread{

	private String senceName = "文字聊天";
	//设置服务器的ip和端口
	String site = "172.25.159.8";//服务器ip
	int sendBf_Max = 1024 * 128;
	int port = 4008;
    public static final String commes = "cm";
    
    private String workId =commes; 
